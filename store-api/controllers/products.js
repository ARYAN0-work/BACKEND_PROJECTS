...
const getAllProductsStatic = async(req,res)=>{
    const products = await Product.find({}).select('name price')//and if we want to add price dont add , just add price .sort('name price')//same with .sort('-name')// now our response is gonna be in alphabetical order
